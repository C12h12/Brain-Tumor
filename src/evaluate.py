#loading of testing data from data/processed and rescaling it.
# Then evaluation of models performance using classification and confusion matrix is done.
...
def m_evaluate(config_file):
    ...
    #test_set contains the rescaled images in [0,1] range.
