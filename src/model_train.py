...
def train_model(config_file):
    ...
    if train == True:
        ...
        mod = Model(inputs = resnet.input, outputs = prediction)    #just creating a new model which has configurations of vgg16's input layer.
                                                                    #and customized vgg16's output layer which we have defined.
        print(mod.summary())
